...
{
    /// <summary>
    /// This class represents an administrative manager.
    /// </summary>
    public class AdministrativeManager : Employee, IEmployee
    {
        /// <summary>
        /// Instantiates a new instance of the AdministrativeManager class.
        /// </summary>
        ...
        public AdministrativeManager(string firstName, string lastName, Jobs jobTitle, int age, decimal salary)
