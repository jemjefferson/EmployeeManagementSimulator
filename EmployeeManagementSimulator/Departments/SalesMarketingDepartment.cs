...
{
    /// <summary>
    /// This class represents the sales and marketing department of the company.
    /// </summary>
    public class SalesMarketingDepartment : IDepartment, ISubject
    {
        /// <summary>
        /// Instance of the class.
        /// </summary>
        private static SalesMarketingDepartment instance;
        ...
        /// <summary>
        /// Instantiates a new instance of the SalesMarketing department.
        /// </summary>
        private SalesMarketingDepartment()
        {
            this.employees = new List<Employee>();
        }

        // This method gets the single instance of this department.
        public static SalesMarketingDepartment GetInstance()
        {
            if (instance == null)
            {
                instance = new SalesMarketingDepartment();
            }
            return instance;
        }
