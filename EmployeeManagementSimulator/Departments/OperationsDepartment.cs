...
{
    /// <summary>
    /// This class represents the operations department of the company.
    /// </summary>
    public class OperationsDepartment : IDepartment, ISubject
    {
        /// <summary>
        /// Instance of the class.
        /// </summary>
        private static OperationsDepartment instance;
        ...
        /// <summary>
        /// Instantiates a new instance of the Operations department.
        /// </summary>
        private OperationsDepartment()
        {
            this.employees = new List<Employee>();
        }

        // This method gets the single instance of this department.
        public static OperationsDepartment GetInstance()
        {
            if (instance == null)
            {
                instance = new OperationsDepartment();
            }
            return instance;
        }
